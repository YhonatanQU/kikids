-- =====================================================================
-- Migración: corrige "column reference order_number is ambiguous"
-- =====================================================================
-- Causa: la función declara RETURNS TABLE (order_id uuid, order_number
-- text), lo que crea parámetros de salida con esos nombres. Dentro del
-- cuerpo, "order_number" quedaba ambiguo frente a la columna real
-- orders.order_number. Se soluciona calificando esa referencia.
--
-- create or replace function es idempotente: ejecutar esto una sola
-- vez en el SQL Editor de Supabase reemplaza la versión con el bug.
-- =====================================================================
